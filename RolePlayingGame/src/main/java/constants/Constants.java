...
public abstract class Constants {
	...
	public static final String GAME_MENU_OPTION = "Select Game to resume , To start a new game type new and press Enter";
	...
	public static final String MOVE_RIGTH = "4";
